...
if (location.hostname == "moodle.mosbach.dhbw.de") {
  ...
  const answers = {
    ...
    "Im Rahmen seines Studiums nutzt Raphael eine Software zum technischen Zeichnen, die ihm durch die DHBW zur Verfügung gestellt wird. Ein Freund, der an einer anderen Hochschule\xa0 studiert, ist beeindruckt von den Möglichkeiten der Software und möchte sie für sein Studium nutzten. „Kein Problem.“ sagt Raphael „ Ich brenn dir einfach die CD mit dem Programm, dann kannst du auch damit arbeiten.“Ist das möglich?": ["Nein, Software darf grundsätzlich nicht vervielfältigt oder an Dritte weitergeben werden, auch nicht an Freunde oder Verwandte."],
